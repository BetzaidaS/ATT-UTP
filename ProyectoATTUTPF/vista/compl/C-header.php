...
<body>
  <header>
    <div>
      <nav class="navbar navbar-light py-0 padding-top:0">
        ...
        <div class="navbar-nav">
          <a class="nav-item nav-link" href="?op=login">Cerrar Sesion</a>
        </div>
    </div>
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#68086c;" class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
      ...
      <ul class="menu">
        <li class="nav-item"><a class="nav-menu-link nav-link nav-menu-link_active" href="?op=inicioC">Inicio</a></li>
        <li class="nav-item"><a class="nav-link" href="?op=solicitudC">Solicitud</a></li>
        <li class="nav-item"><a class="nav-link" href="?op=estadoSolicitudC">Estado De Solicitud</a></li>
      </ul>
      </div>
    </nav>
  </header>
